...
#TAG='d80eefe94738ab6bd35cca64747d877c49337318' # FIREFOX_120_0_1_RELEASE
case "$(uname -s)" in
   Darwin)
...
#UNBRANDED_REALEASE_BUILD="https://ftp.mozilla.org/pub/firefox/releases/90.0.2/linux-x86_64/en-US/firefox-90.0.2.tar.bz2"
#wget -q "$UNBRANDED_RELEASE_BUILD" -O "target${TARGET_SUFFIX}"
wget -q https://ftp.mozilla.org/pub/firefox/releases/90.0.2/linux-x86_64/en-US/firefox-90.0.2.tar.bz2 -O target.tar.bz2
